...
// struct that is bounded to a generic type <F:Field>
...
// impl<F: Field> FiboChip<F> defines an implementation of the FiboChip struct for a generic type parameter F that implements the Field trait
