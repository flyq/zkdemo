...
impl<F: PrimeField, const RANGE: usize, const LOOKUP_NUMBITS: usize, const LOOKUP_RANGE: usize>
    RangeCheckConfig<F, RANGE, LOOKUP_NUMBITS, LOOKUP_RANGE>
{
...
impl<F: PrimeField, const RANGE: usize, const LOOKUP_NUMBITS: usize, const LOOKUP_RANGE: usize>
    Circuit<F> for MyCircuit<F, RANGE, LOOKUP_NUMBITS, LOOKUP_RANGE>
{
    ...
    fn synthesize(
        ...
        config.assign(
            ...
            self.value,
            self.large_value_num_bits.unwrap_or(8),
            LOOKUP_RANGE,
        )?;
